    ...
    <aside className="w-64 bg-gray-900 border-r border-gray-800 p-4 flex flex-col">
      ...
      <div className="mt-auto p-4 bg-gray-800 rounded-xl">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 bg-brand-600 rounded-full flex items-center justify-center text-white font-bold">A</div>
          <div>
            <div className="text-sm font-semibold">Andre</div>
